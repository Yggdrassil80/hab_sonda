...
class UbxStream(object):
    ...
    # 0xF0 = 240 / 0xF1 = 241
    # NMEA Messages:
    # class 0xF0: 0A(DTM), 09(GBS), 00(GGA), 01(GLL), 0D, 06(GRS), 02(GSA), 07(GST), 03(GSV), 04(RMC), 41(TXT), 0F, 05(VTG), 08(ZDA)
    # class 0xF1: 00, 03, 04
...
#puertoUSB=serial.Serial('COM4', timeout = 5.0, baudrate=9600)
#
#x = UbxStream(puertoUSB)
#
#x.load_config()
#x.disable_NMEA()
...
#		print("Dato entrante...")
#		buffer = puertoUSB.read(50)
#		print ("Dato leido en ACII: " + buffer)
#		time.sleep(1)